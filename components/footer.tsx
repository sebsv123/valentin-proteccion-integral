      ...
      <div className="container-shell py-14">
        <div className="grid gap-8 lg:grid-cols-[1.35fr_1fr_1fr_1fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-xl text-base leading-8 text-[var(--muted)]">Valentín Protección Integral ofrece asesoramiento personalizado para asegurar tu tranquilidad. Te acompañamos con cercanía antes y después de contratar.</p>
        ...
        <div className="mt-10 grid gap-4 border-t border-[var(--border)] pt-6 text-sm leading-7 text-[var(--muted)] md:grid-cols-3">
          ...
          <p>Valentín Protección Integral es la marca comercial bajo la que desarrollamos nuestra actividad como agentes exclusivos de seguros.</p>
        </div>
